    ...
    <footer className="bg-[color:var(--navy)] text-white/90">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 grid gap-10 md:grid-cols-4">
        <div className="md:col-span-2">
          <div className="flex items-center gap-3">
            <img src={logo} alt="SDS Consulting Services" className="h-14 w-auto bg-white rounded-lg p-1.5" />
            <div>
          ...
          <p className="mt-5 max-w-md text-sm text-white/70 leading-relaxed">
            Enterprise-grade staffing, AI infrastructure deployment, and 24/7 operational
            services for the world's most demanding data centers.
          </p>
        </div>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 text-xs text-white/50 flex flex-wrap items-center justify-between gap-3">
          ...
          <span>Chicago • Built for enterprise data centers</span>
        </div>
      </div>
    </footer>
  );
