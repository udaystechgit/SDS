...
const it: Service[] = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1591808216268-ce0b82787efe?auto=format&fit=crop&w=1400&q=80",
...
const dc: Service[] = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1606166187734-a4cb74079037?auto=format&fit=crop&w=1400&q=80",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1610563166150-b34df4f3bcd6?auto=format&fit=crop&w=1400&q=80",
      ...
      <div className="p-6">
        ...
        <div className="mt-5 flex flex-wrap gap-2">
          {s.idealFor.map((t) => (
            <span
              key={t}
              className="text-[10px] uppercase tracking-wider px-2.5 py-1 rounded-full bg-secondary text-secondary-foreground font-semibold"
            >
              {t}
            </span>
          ))}
        ...
        <Link
          to="/contact"
          className="mt-6 inline-flex items-center gap-2 font-semibold text-[color:var(--brand-deep)] text-sm hover:gap-3 transition-all"
        >
      ...
      <section id="it-ai" className="py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between flex-wrap gap-4">
            ...
            <Link
              to="/contact"
              className="text-sm font-semibold text-[color:var(--brand-deep)] inline-flex items-center gap-2 hover:gap-3 transition-all"
            >
